...
export const PROPERTY_DELETE_RESET = 'PROPERTY_DELETE_RESET';

export const PROPERTY_OFFICE_LIST_REQUEST = 'PROPERTY_OFFICE_LIST_REQUEST';
export const PROPERTY_OFFICE_LIST_SUCCESS = 'PROPERTY_OFFICE_LIST_SUCCESS';
export const PROPERTY_OFFICE_LIST_FAIL = 'PROPERTY_OFFICE_LIST_FAIL';